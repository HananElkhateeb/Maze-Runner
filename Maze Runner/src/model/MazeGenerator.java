...
public class MazeGenerator {
	...
	final Trees trees = Trees.getInstance();
	final BombsFirstType bomb1 = BombsFirstType.getInstance();
	final BombsSecondType bomb2 = BombsSecondType.getInstance();
	final GiftsFirstType gift1 = GiftsFirstType.getInstance();
	final GiftsSecondType gift2 = GiftsSecondType.getInstance();
